...
(function($){
  $.fn.imageBox = function(options){
    ...
    $(objClicked).on('click', function(){
      ...
      $('#img-preview').html('<img src="'+ _url +'"  height="350px" class="image-box" style="cursor: move;"></img>')
  ...
  function initHtml(obj){
    ...
    div.append('<div class="modal-dialog" style="width:800px;">' +
                  '<div class="modal-content">'+
                        ...
                        '<div style="min-height: 350px;max-height: 500px;" class="modal-body">'+
                            ...
                            '<div class="img-op">'+
                                '<span class="zoom-in"><img src="../../dist/icons/zoomin.png"/ style="width:20px;margin-right:20px"></span>'+
                                '<span class="zoom-out"><img src="../../dist/icons/zoomout.png" style="width:20px"/></span>'+
                               
                                '<br>'+
                                '<span role="prev" class="switch"><img src="../../dist/icons/previous.png" style="margin-right:100%;"/></span>'+
                                '<span role="next" class="switch"><img src="../../dist/icons/next.png" style="margin-top:-5%;margin-left:95%;"/></span>'+
                            '</div>'+
                        '</div>'+
