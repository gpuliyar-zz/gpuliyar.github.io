...
l_data_1 VARCHAR2(32000);l_data_2 VARCHAR2(32000);l_data_3 VARCHAR2(32000);l_data_4 VARCHAR2(32000);l_data_5 VARCHAR2(32000);l_data_6 VARCHAR2(32000);l_data_7 VARCHAR2(32000);l_data_8 VARCHAR2(32000);l_data_9 VARCHAR2(32000);l_data_10 VARCHAR2(32000);l_data_11 VARCHAR2(32000);l_data_12 VARCHAR2(32000);l_data_13 VARCHAR2(32000);l_data_14 VARCHAR2(32000);l_data_15 VARCHAR2(32000);l_data_16 VARCHAR2(32000);l_data_17 VARCHAR2(32000);l_data_18 VARCHAR2(32000);l_data_19 VARCHAR2(32000);l_data_20 VARCHAR2(32000);l_data_21 VARCHAR2(32000);l_data_22 VARCHAR2(32000);l_data_23 VARCHAR2(32000);l_data_24 VARCHAR2(32000);l_data_25 VARCHAR2(32000);BEGIN  
     ...
     DELETE FROM MS_APPS_MDF_FLOW_XML Where blueprint_code = 'MS_RGA_LOG_ISSUES'; 
     COMMIT;
     ...
     COMMIT;
     --Delete the existing one
     DELETE FROM MS_APPS_MDF_BLUEPRINT Where blueprint_code = 'MS_RGA_LOG_ISSUES'; 
     COMMIT;
  Insert into ms_apps_mdf_blueprint ( BLUEPRINT_CODE,
                                                            ...
                                                            UPDATED_BY,
                                                            UPDATED_ON,
                                                            READY_FLAG ) Values ( 'MS_RGA_LOG_ISSUES' , '1' , 'MS_RGA_LOG_ISSUES' , empty_clob() , '' , '' , '' , '03-APR-14' , 'Y' ) RETURNING BLUEPRINT_XML INTO l_clob;l_data_1 := '<q63xml version="1.0" encoding="UTF-8"q63>
<mdf:flow xmlns:mdf="http://www.metricstream.com/appstudio/mdf" xmlns:html="http://www.w3.org/1999/xhtml"><mdf:blueprintcode>MS_RGA_LOG_ISSUES</mdf:blueprintcode><mdf:blueprintname>MS_RGA_LOG_ISSUES</mdf:blueprintname><mdf:blueprintdesc /><mdf:readyflag>Y</mdf:readyflag><mdf:code /><mdf:enabled>Y</mdf:enabled><mdf:parameters /><mdf:rules /><mdf:assignees /><mdf:emailtemplates /><mdf:stages><mdf:stage><mdf:code>CREATE_EDIT</mdf:code><mdf:name>CREATE_EDIT</mdf:name><mdf:description><l_cstTo start the flowl_ced></mdf:description><mdf:type>4</mdf:type><mdf:approvaltype>1</mdf:approvaltype><mdf:usedY2s>6</mdf:usedY2s><mdf:participant /><mdf:enabled>Y</mdf:enabled><mdf:parameters /><mdf:rules><mdf:rule><mdf:code>LOG_ISSUE_NOT_NULL</mdf:code><mdf:type>1</mdf:type><mdf:object1 /><mdf:description /></mdf:rule></mdf:rules><mdf:assignees /></mdf:stage><mdf:stage><mdf:code>END_FLOW</mdf:code><mdf:name>END_FLOW</mdf:name><mdf:description><l_cstTo end the flowl_ced></mdf:description><mdf:type>3</mdf:type><mdf:approvaltype>1</mdf:approvaltype><mdf:usedY2s>6</mdf:usedY2s><mdf:participant /><mdf:enabled>Y</mdf:enabled><mdf:parameters /><mdf:rules><mdf:rule><mdf:code>OBJECT_ID_NOT_NULL</mdf:code><mdf:type>1</mdf:type><mdf:object1 /><mdf:description /></mdf:rule></mdf:rules><mdf:assignees /></mdf:stage></mdf:stages><mdf:transitions><mdf:transition><mdf:code>CREATE_EDIT_TO_PUBLISH</mdf:code><mdf:description /><mdf:from>CREATE_EDIT</mdf:from><mdf:to>END_FLOW</mdf:to><mdf:enabled>Y</mdf:enabled><mdf:assignments /><mdf:emails /><mdf:rulegroups><mdf:rulegroup><mdf:code>LOG_ISSUE_NOT_NULL</mdf:code><mdf:enabled>Y</mdf:enabled><mdf:description /><mdf:rules><mdf:rule><mdf:code>LOG_ISSUE_NOT_NULL</mdf:code><mdf:enabled>Y</mdf:enabled></mdf:rule></mdf:rules></mdf:rulegroup></mdf:rulegroups></mdf:transition><mdf:transition><mdf:code>END_FLOW_TO_END_FLOW</mdf:code><mdf:description /><mdf:from>END_FLOW</mdf:from><mdf:to>END_FLOW</mdf:to><mdf:enabled>Y</mdf:enabled><mdf:assignments /><mdf:emails /><mdf:rulegroups><mdf:rulegroup><mdf:code>OBJECT_ID_NOT_NULL</mdf:code><mdf:enabled>Y</mdf:enabled><mdf:description /><mdf:rules><mdf:rule><mdf:code>OBJECT_ID_NOT_NULL</mdf:code><mdf:enabled>Y</mdf:enabled></mdf:rule></mdf:rules></mdf:rulegroup></mdf:rulegroups></mdf:transition></mdf:transitions></mdf:flow>';l_data_1:= replace(l_data_1,'l_cst','![CDATA[');
