 ...
 *       &lt;sequence>
 *         &lt;element name="requirement" type="{}RQTType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataLinesType {
    ...
    protected List<RQTType> requirement;
     ...
     * 
     */
    public List<RQTType> getRequirement() {
        if (requirement == null) {
            requirement = new ArrayList<RQTType>();
        }
